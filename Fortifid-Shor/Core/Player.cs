...
public class Player : Entity
{
    ...
    private void TryInteract(WorldMap world)
    {
        ...
        if (gained > 0)
            System.Console.WriteLine($"[Гравець] Отримано: {gained}x {tile.Object.ResorurceName}");
    ...
    public override void Draw(SpriteBatch spriteBatch, Camera camera)
    {
        ...
        {
            var rect = new  Rectangle((int)screenPos.X, (int)screenPos.Y, Draw_Size, Draw_Size);
        }
    }
}